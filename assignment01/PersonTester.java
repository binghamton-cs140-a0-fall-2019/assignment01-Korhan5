...
public class PersonTester {
	public static void main(String[] args) {
		...
		DateAndPlaceOfBirth dob2 = new DateAndPlaceOfBirth(2000, 3, 9, "Oceanside", "NY", "US");
		StreetUSAddress add2 = new StreetUSAddress("2809 Brower Ave", "2nd Floor", "Oceanside", "NY", "11572") ;
		Person John2 = new Person("John", "Smith", "123456789", dob, add );
